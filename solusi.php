...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="solusi.php" class="nav-item nav-link active"><i class="fas fa-list me-2"></i>Solusi</a>
    ...
    doc.setFontSize(16);
    doc.setFont("Times", "bold");
    doc.text('Data Solusi', pageWidth / 2, 50, { align: 'center' });
    ...
    doc.save('data_Solusi.pdf');
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Edit Data Solusi</h5>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <?php while ($row = mysqli_fetch_assoc($Solusi)) : ?>
                                <tr>
                                    <td><?php echo $row['kode']; ?></td>
                                    <td><?php echo $row['nama']; ?></td>
                                    <td>
                                        <button onclick="editsolusi(<?php echo $row['id']; ?>, '<?php echo $row['kode']; ?>', '<?php echo $row['nama']; ?>')" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal">Edit</button>
